        ...
        <div className="footer_columns">
          <div className="footer_column">
            ...
            <div className="low_volt_links">
              <a className="low_volt_link" href>Низковольтное оборудование</a>
              <br />
              <a className="low_volt_link" href>Модульное оборудование</a>
              <br /> 
              <a className="low_volt_link" href>Силовое оборудование защиты и коммутации</a
              >
              <br />
              <a className="low_volt_link" href>Контакторы, реле, пускатели</a>
              <br />
              ...
              >
              <br />
              <a className="low_volt_link" href>Оборудование электропитания</a>
              <br />
              <a className="low_volt_link" href
                >Выключатель-разъединители/рубильники</a
              >
              <br />
              <a className="low_volt_link" href>Приводная техника</a>
              <br />
              <a className="low_volt_link" href>Щиты и шкафы</a>
              <br />
              <a className="low_volt_link" href
          ...
          <div class="footer_column">
            ...
            <div className="low_volt_links">
              ...
              <br />
              <a className="low_volt_link" href>Мероприятия</a>
              <br />
              <a className="low_volt_link" href>Поддержка</a>
              <br />
              <a className="low_volt_link" href>Контакты</a>
            </div>
